...
%   MATLAB mirror of the Python bridge avoidance utilities.
    ...
    methods (Static)
        ...
        function waypoints = PlanBridgeSafeWaypoints(start_pose, target_pose, zone, zones, opts)
            ...
            x_scan_min = OpenManipulator.BridgeAvoidance.getOpt(opts, 'x_scan_min', 80.0);
            x_front_offset = OpenManipulator.BridgeAvoidance.getOpt(opts, 'x_front_offset', 30.0);
            x_retreat_offset = OpenManipulator.BridgeAvoidance.getOpt(opts, 'x_retreat_offset', 40.0);
            ...
            approach_x = OpenManipulator.BridgeAvoidance.findSafeApproachX(target(3), target(2), approach_pitch, zones, x_scan_min, x_front_offset, zone.x_min);
            ...
            if start_under && ~target_under
                ...
                exit_x = min([approach_x, zone.x_min - x_retreat_offset]);
            ...
            if start_under && target_under
                exit_x = min([zone.x_min - x_retreat_offset, start(1), target(1)]);
