...
% --- Bridge Geometry ---
BRIDGE_HALF_WIDTH_X = 5.0; % Fixed bridge half-width in X (mm)
BRIDGE_Z_MAX = 105.0;
BRIDGE_GAP_Y = 50.0;
BRIDGE_Y_MIN = -35.0;
BRIDGE_Y_MAX = 35.0;
...
% Planner X tuning (relative to bridge front face)
X_SCAN_MIN = 80.0;
X_FRONT_OFFSET = 30.0;
X_RETREAT_OFFSET = 40.0;

% --- Runtime bridge placement ---
fprintf('Enter bridge center X (mm) (default 225): ');
user_in = input('');
if isempty(user_in), bridge_center_x = 225.0; else, bridge_center_x = double(user_in); end
